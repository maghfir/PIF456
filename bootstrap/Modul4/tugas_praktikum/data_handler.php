<!DOCTYPE html>
 ...
 <div class="navbar navbar-inverse">
    <ul class="nav navbar-nav">
      <li class="active"><a href="http://localhost/bootstrap/Modul4/tugas_praktikum">Modul 4=Tugas Praktikum</a></li>
	  <li class="active"><a href="http://localhost/bootstrap/Modul4/tugas_praktikum/logout.php">Logout</a></li>
    </ul>
  </div><!-- /.navbar-collapse -->
